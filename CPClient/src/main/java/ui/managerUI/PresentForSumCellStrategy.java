...
* @description
*/
public class PresentForSumCellStrategy implements Strategy{
	...
	public void initData(SinglePresentController controller,PresentVO vo) {
		...
		System.out.println("init data in present for sum cell");
		
		PresentForSumCellController sumController = (PresentForSumCellController)controller;
