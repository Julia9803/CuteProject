...
* @description
*/
public class PresentForSpecialPackageCellStrategy implements Strategy{
	...
	public void initData(SinglePresentController controller,PresentVO vo) {
		...
		System.out.println("init data in present for SpecialPackage cell");
		
		PresentForSpecialPackageCellController SpecialPackageController = (PresentForSpecialPackageCellController)controller;
