...
* @description
*/
public class PresentForSumCellController implements SinglePresentController{
    ...
    @FXML PresentForSumListController controller;
    PresentForSumVO vo;
    Strategy strategy;
	 ...
	 * @param vo
	 */
	public PresentForSumCellController(PresentForSumListController controller, PresentForSumVO vo) {
