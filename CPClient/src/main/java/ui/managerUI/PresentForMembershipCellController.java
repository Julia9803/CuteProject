...
* @description
*/
public class PresentForMembershipCellController implements SinglePresentController{
    ...
    @FXML PresentForMembershipListController controller;
    PresentForMembershipVO vo;
    Strategy strategy;
    ...
    /**
	 * @param presentForMembershipListController
	 * @param vo
	 */
	public PresentForMembershipCellController(PresentForMembershipListController controller, PresentForMembershipVO vo) {
		// TODO Auto-generated constructor stub
		this.controller = controller;
		this.vo = vo;
		this.strategy = new PresentForMembershipCellStrategy();
	}
	...
	@FXML void edit(){
		Platform.runLater(()->{
		try {
   		 Strategy strategy = new PresentForMembershipEditStrategy();
   		 PresentForMembershipController controller = 
   				    new PresentForMembershipController(strategy,this.controller.getManagerController(),vo);
