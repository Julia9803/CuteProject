...
* @description
*/
public class StockReturnWriteoffEditController extends StockReturnEditListController{
	 ...
	 * @param vo
	 */
	public StockReturnWriteoffEditController(ParentController parentController, SaleUniBLService uniBLService, String id,
			SalesmanListVO vo) {
